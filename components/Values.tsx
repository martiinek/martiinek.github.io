    ...
    <section id="values" className="py-24 reveal">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {VALUES.map((value, idx) => (
          <div key={value.title} className="relative p-10 rounded-2xl overflow-hidden group hover:scale-[1.02] transition-all duration-500 border border-gray-800 bg-neutral-900/70 backdrop-blur-md shadow-sm hover:shadow-2xl">
            ...
            <div className={`w-12 h-12 rounded-xl mb-8 flex items-center justify-center ${idx === 0 ? 'bg-orange-900/20 text-orange-400' : idx === 1 ? 'bg-amber-900/20 text-amber-400' : 'bg-red-900/20 text-red-400'}`}>
            ...
            <p className="text-gray-400 leading-relaxed font-light text-sm mb-10">
              {value.description}
            </p>
