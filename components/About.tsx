      ...
      <div className="grid lg:grid-cols-12 gap-16 items-start">
        <div className="lg:col-span-4">
          <div className="sticky top-32 p-10 border border-gray-800 bg-neutral-900/70 backdrop-blur-md shadow-sm rounded-2xl relative">
           ...
           <div className="mono text-[10px] text-gray-400 leading-relaxed mb-8">
        ...
        <div className="lg:col-span-8">
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12">
              <div className="p-6 border border-gray-800 bg-neutral-900/70 backdrop-blur-md hover:border-orange-500 transition-all group rounded-2xl shadow-sm hover:shadow-md">
                ...
                <div className="flex flex-wrap gap-2 text-xs mono">
                  {['Embedded systems', 'Linux', 'Matlab', 'Python', 'C/C++', 'Git', 'CAD', 'PCB design'].map(t => (
                    <span key={t} className="px-2 py-1 bg-neutral-900 border border-gray-800 rounded-lg group-hover:border-orange-400 transition-colors">+{t}</span>
                  ))}
                </div>
              </div>
              <div className="p-6 border border-gray-800 bg-neutral-900/70 backdrop-blur-md hover:border-amber-400 transition-all group rounded-2xl shadow-sm hover:shadow-md">
                ...
                <div className="flex flex-wrap gap-2 text-xs mono">
                  {['Nezávislost', 'Růst', 'Vzdělání', 'Efektivita'].map(t => (
                    <span key={t} className="px-2 py-1 bg-neutral-900 border border-gray-800 rounded-lg group-hover:border-amber-400 transition-colors">*{t}</span>
                  ))}
                </div>
              </div>
            </div>
